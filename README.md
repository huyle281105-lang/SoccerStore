...
> 💡 **Ghi chú portfolio**: Module 13 và 14 là điểm nhấn tốt để đưa vào CV/phỏng vấn — không chỉ viết test case theo happy path mà còn tìm ra 3 lỗi thật sự (2 lỗi validation nghiệp vụ + 1 lỗi bảo mật IDOR), thể hiện tư duy kiểm thử chủ động thay vì chỉ xác nhận tính năng hoạt động đúng.